...
Lara's Plots with CDC MCH Data
```{r eval=FALSE, include=FALSE}
#can delete this code chunk, it set it not to run bc when it did, it would pop up the 3 mcf tables -- zainab
View(MCH.CDC.Data)
...
MCH.CDC.Data %>% group_by(County) %>% ggplot(aes(Year, Fertility.Rate, color = County)) + geom_line() + labs( y="Fertility Rate", title = "Fertility Rate by County", subtitle = "2007-2019", color = "County", caption = "Data Source: CDC WONDER Online Database")
#Look at HW 2 Vaccine stuff to see how to best look at this. (Heat map, box plot)
...
#facetgrid 
#compare to non-agricultural areas 
```
NOTE: Need to figure out a better way to do all county data visualization ... 

```{r}
#Racial Demographic GGPLOTS
MCH.CDC.Data_Race %>% group_by(County) %>% ggplot(aes(Year, Total.Population, color = Mothers.Race)) + geom_line()  + labs( y="Total Population", title = "Racial Demographics by County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Race %>% group_by(County) %>% ggplot(aes(Year, Total.Population, color = Mothers.Race)) + geom_line() + scale_y_log10() + labs( y="Total Population (Log 10 Transformation)", title = "Racial Demographics by County (Transformed Y Axis)", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Race %>% group_by(County) %>% filter(County == "Fresno") %>% ggplot(aes(Year, Total.Population, color = Mothers.Race)) + geom_line() + labs( y="Total Population", title = "Racial Demographics in Fresno County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 
...
MCH.CDC.Data_Race %>% group_by(County) %>% filter(County == "Kern") %>%  ggplot(aes(Year, Total.Population, color = Mothers.Race)) + geom_line() + labs( y="Total Population", title = "Racial Demographics in Kern County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 
...
MCH.CDC.Data_Race %>% group_by(County) %>% filter(County == "San Joaquin") %>%  ggplot(aes(Year, Total.Population, color = Mothers.Race)) + geom_line() + labs( y="Total Population", title = "Racial Demographics in San Joaquin County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 
...
#keep transformed versions
#non-agricultural counties 

```
NOTE: Need to figure out a better way to do all county data visualization ... 
NOTE: Pick one year and do bar plot (2016) or ()

```{r}
#Race and Preterm Birth GGPLOTS
MCH.CDC.Data_Race %>% group_by(County) %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "Fresno") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in Fresno County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "San Joaquin") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in San Joaquin County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "Kern") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in Kern County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "San Bernardino") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in San Bernardino County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "Los Angeles") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in Los Angeles County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Race %>% filter(County == "San Diego") %>% ggplot(aes(Year, Average.LMP.Gestational.Age, color = Mothers.Race)) + geom_line() + labs( y="Average LMP Gestational Age (Weeks)", title = "Preterm Birth in San Diego", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

#add Tulare 
``` 
NOTE: Need to figure out a better way to do all county data visualization ... 
NOTE: Add Horizontal Line for Preterm Birth Cutoffs 

```{r}
#Race and Fertility GGPLOTS
MCH.CDC.Data_Race %>% group_by(County) %>% ggplot(aes(Year, Fertility.Rate, color = Mothers.Race)) + geom_line() + labs( y="Fertility Rate", title = "Race and Fertility Data", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 
...
```{r}
#Race and Prenatal Care GGPLOTS
MCH.CDC.Data_Care %>% group_by(County) %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database") 

MCH.CDC.Data_Care %>% filter(County == "Fresno") %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data in Fresno County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Care %>% filter(County == "Kern") %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data in Kern County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Care %>% filter(County == "San Bernardino") %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data in San Bernardino County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Care %>% filter(County == "Los Angeles") %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data in Los Angeles County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")

MCH.CDC.Data_Care %>% filter(County == "San Diego") %>% ggplot(aes(Year, Month.Prenatal.Care.Began, color = Mothers.Race)) + geom_line() + labs( y="Month Prenatal Care Began", title = "Race and Prenatal Care Data in San Diego County", subtitle = "2007-2019", color = "Mother's Race", caption = "Data Source: CDC WONDER Online Database")
```
NOTE: Fix all these graphs... 

NOTE: ADD BIRTHWEIGHT AND RACE ANALYSIS 
