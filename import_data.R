...
table1_2016 <- county_ranks16 %>% transmute(county = str_to_lower(COUNTY), 
...
all_dat <- list(table1_2007, table1_2008,
                table1_2009, table1_2010,
                table1_2011, table1_2012,
                table1_2013, table1_2014,
                table1_2015, table1_2016)
